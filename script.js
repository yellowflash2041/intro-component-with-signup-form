document
  .getElementById("exampleInputName")
  .addEventListener("click", InputName);
document
  .getElementById("exampleInputLastName")
  .addEventListener("click", InputLastName);
document
  .getElementById("exampleInputemailaddress")
  .addEventListener("click", Inputemailaddres);
document
  .getElementById("exampleInputPassword1")
  .addEventListener("click", InputPassword1);

document
  .getElementById("submit_btn")
  .addEventListener("click", click_on_submit);

document
  .getElementById("exampleInputName")
  .addEventListener("keyup", change_Input_Name);
document
  .getElementById("exampleInputLastName")
  .addEventListener("keyup", change_Input_LastName);
document
  .getElementById("exampleInputemailaddress")
  .addEventListener("keyup", change_Input_emailaddres);
document
  .getElementById("exampleInputPassword1")
  .addEventListener("keyup", chamge_Input_Password1);

function InputName() {
  document.getElementById("Last_Name_Input_Border").style.borderColor =
    "#CED4DA";
  document.getElementById("Email_Input_Border").style.borderColor = "#CED4DA";
  document.getElementById("Password_Input_Border").style.borderColor =
    "#CED4DA";

  document.getElementById("Name_Input_Border").style.borderColor =
    "rgba(100, 100, 100, 1)";
...
function Inputemailaddres() {
  ...
  document.getElementById("Email_Input_Border").style.borderColor =
    "rgba(100, 100, 100, 1)";
  // document.getElementById("hole_input").style.boxShadow = "rgba(100, 100, 100, 1)";
}
...
function click_on_submit() {
  ...
  if (Email_Input == "") {
    ...
    document
      .getElementById("exampleInputemailaddress")
      .classList.add("placeholder_style");

    document.getElementById("exampleInputemailaddress").placeholder =
      "email@example/com";
  } else {
